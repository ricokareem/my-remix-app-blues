...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create my-remix-app-blues-fae4
  fly apps create my-remix-app-blues-fae4-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app my-remix-app-blues-fae4
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app my-remix-app-blues-fae4-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'my-remix-app-blues-fae4-staging' does not match app name in config file 'my-remix-app-blues-fae4'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name my-remix-app-blues-fae4-db
  fly postgres attach --app my-remix-app-blues-fae4 my-remix-app-blues-fae4-db

  fly postgres create --name my-remix-app-blues-fae4-staging-db
  fly postgres attach --app my-remix-app-blues-fae4-staging my-remix-app-blues-fae4-staging-db
  ```
